                            ...
                            <div class="form-group">
                                ...
                                <select name="payment" class="form-control @error('payment') is-invalid @enderror">
                                    @foreach (['Thanh toán khi nhận hàng', 'Thanh toán bằng thẻ', 'Thanh toán qua VNPay'] as $payment)
                                        <option value="{{ $payment }}" {{ old('payment', $order->payment) == $payment ? 'selected' : '' }}>
                                            {{ $payment }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="shiping" class="form-control @error('shiping') is-invalid @enderror" value="{{ old('shiping', $order->shiping) }}">
                                @error('shiping')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
