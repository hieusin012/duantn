<aside id="sidebar" class="app-sidebar" style="width: 250px">
      ...
      <ul class="app-menu">
            ...
            <li><a class="app-menu__item {{ request()->routeIs('admin.product_comments.*') ? 'active' : '' }}" href="{{ route('admin.product_comments.index') }}">
                        <i class="app-menu__icon fas fa-comments"></i><span class="app-menu__label">Bình luận sản phẩm</span></a></li>
