...
<head>
    ...
    <!-- jsvectormap css -->
    <link href="{{ asset('assets1/libs/jsvectormap/jsvectormap.min.css') }}" rel="stylesheet" type="text/css" />

    <!-- Swiper slider css -->
    <link href="{{ asset('assets1/libs/swiper/swiper-bundle.min.css') }}" rel="stylesheet" type="text/css" />
...
<!-- Vector map-->
<script src="{{ asset('assets1/libs/jsvectormap/jsvectormap.min.js') }}"></script>
<script src="{{ asset('assets1/libs/jsvectormap/maps/world-merc.js') }}"></script>

<!-- Swiper slider js -->
<script src="{{ asset('assets1/libs/swiper/swiper-bundle.min.js') }}"></script>

<!-- Dashboard init -->
<script src="{{ asset('assets1/js/pages/dashboard-ecommerce.init.js') }}"></script>
